            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                ...
                switch (item.getItemId()){
                    case R.id.profile_page:
                        ...
                        return true;
                    case R.id.home_page:
                   // DatabaseHelper.findUsers(currentUser.getGender(), currentUser.getPreference(), currentUser.getAgeMin(), currentUser.getAgeMax(), currentUser.getAge());
